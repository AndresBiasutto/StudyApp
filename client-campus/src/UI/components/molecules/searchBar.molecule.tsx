...
const SearchBar = () => {
  return (
    <div className="w-full flex items-center justify-center gap-2 p-1 m-2 border border-lightBorder dark:border-darkBorder rounded font-sharetech text-lightText">
      <input
